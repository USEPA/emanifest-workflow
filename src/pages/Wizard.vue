      ...
      <v-col cols="12" lg="7" md="8">
        ...
        <v-card title="Workflow Scenario Information">
          ...
          <v-card-text>
            ...
            <v-radio-group v-model="selectedVsqg">
              <template #label>
                <div class="d-inline-flex align-center flex-wrap">
                  ...
                  <tooltip
                    :link="hwipLink"
                    link-text="RCRAInfo Hazardous Waste Information Platform"
                    tip-location="vsqg"
                    type="info"
                  />
                </div>
            ...
            <v-alert
              v-if="electronicNoGenIdScenario"
              border="start"
            ...
            <v-card-text class="ml-12">
              ...
              <div v-if="step.print">
                ...
                <v-alert border="start" border-color="blue accent-4" class="my-2">
                  ...
                  the generator
                  site. Copies can be printed by any party. There are <a
                    href="#"
                    @click.prevent="printDialog = true"
                  >two options</a> for printing
                  the
                  manifest.
    ...
    <v-card title="Printing Options">
      <v-card-text>
        ...
        manifest and continuation sheet <a
          ...
          target="_blank"
        >templates <v-icon icon="mdi-open-in-new" size="18" /></a>. Then configure
        your system to
